...
public class DonHangChiTiet implements Serializable {
    ...
    public com.example.myapplication.Presentation.Homepage.phuchoi.Model.SanPham getSanPham() {
        return SanPham;
    }

    public void setSanPham(com.example.myapplication.Presentation.Homepage.phuchoi.Model.SanPham sanPham) {
        SanPham = sanPham;
    }
