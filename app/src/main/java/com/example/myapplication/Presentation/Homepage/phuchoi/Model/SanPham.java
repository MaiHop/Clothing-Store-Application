...
public class SanPham implements Serializable {
    ...
    public com.example.myapplication.Presentation.Homepage.phuchoi.Model.KichThuoc getKichThuoc() {
        return KichThuoc;
    }

    public void setKichThuoc(com.example.myapplication.Presentation.Homepage.phuchoi.Model.KichThuoc kichThuoc) {
        KichThuoc = kichThuoc;
    }
    ...
    public com.example.myapplication.Presentation.Homepage.phuchoi.Model.Mau getMau() {
        return Mau;
    }

    public void setMau(com.example.myapplication.Presentation.Homepage.phuchoi.Model.Mau mau) {
        Mau = mau;
    }
