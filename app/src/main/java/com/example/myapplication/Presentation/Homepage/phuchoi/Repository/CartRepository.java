package com.example.myapplication.Presentation.Homepage.phuchoi.Repository;

import com.example.myapplication.Presentation.Homepage.phuchoi.Model.DiaChi;
import com.example.myapplication.Presentation.Homepage.phuchoi.Model.DonHangChiTiet;
...
import com.example.myapplication.Presentation.Homepage.phuchoi.Model.KieuSP;
import com.example.myapplication.Presentation.Homepage.phuchoi.Model.LoaiSP;
...
import com.example.myapplication.Presentation.Homepage.phuchoi.Model.ThanhToan;
import com.example.myapplication.Presentation.Homepage.phuchoi.Model.VanChuyen;
...
public class CartRepository {
    ...
    public List<SanPham> getSanPham(){
        ...
        sp2.setTenSanPham("Miracle Air Áo Khoác (AirSense Áo Khoác) (Wool Like1)");
        sp2.setGiaban(120);
        sp2.setSoLuong(120);
        ...
        sp2.setKichThuoc(listsize.get(0));
        sp2.setKichThuoc(listsize.get(1));
        sp2.setKichThuoc(listsize.get(2));
        sp2.setMau(listcolor.get(0));
        ...
        sp4.setNhomSanPham(listNhomSP.get(1));
        ...
        sp6.setNhomSanPham(listNhomSP.get(1));
