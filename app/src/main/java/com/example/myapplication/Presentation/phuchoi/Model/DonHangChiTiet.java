...
public class DonHangChiTiet implements Serializable {
    ...
    public com.example.myapplication.Presentation.phuchoi.Model.SanPham getSanPham() {
        return SanPham;
    }

    public void setSanPham(com.example.myapplication.Presentation.phuchoi.Model.SanPham sanPham) {
        SanPham = sanPham;
    }
