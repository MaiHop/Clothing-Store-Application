...
public class SanPham implements Serializable {
    ...
    public com.example.myapplication.Presentation.phuchoi.Model.KichThuoc getKichThuoc() {
        return KichThuoc;
    }

    public void setKichThuoc(com.example.myapplication.Presentation.phuchoi.Model.KichThuoc kichThuoc) {
        KichThuoc = kichThuoc;
    }
    ...
    public com.example.myapplication.Presentation.phuchoi.Model.Mau getMau() {
        return Mau;
    }

    public void setMau(com.example.myapplication.Presentation.phuchoi.Model.Mau mau) {
        Mau = mau;
    }
